...
PARAM$trainingstrategy$semilla_azar   <- 307873  #Aqui poner su  primer  semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 929209  #Aqui poner su segunda semilla
...
PARAM$hyperparametertuning$hs  <- makeParamSet(
         ...
         makeIntegerParam("max_bin",    lower=    100L, upper=    250L)
        )
