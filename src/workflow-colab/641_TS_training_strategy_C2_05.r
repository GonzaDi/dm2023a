...
PARAM  <- list()
PARAM$experimento <- "TS6410C205"

PARAM$exp_input  <- "FE6310C2"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202105 )
PARAM$final_train  <- c( 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905 )

PARAM$train$training     <- c( 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903 )
...
PARAM$train$semilla  <- 307873  # cambiar por su propia semilla  !!!
