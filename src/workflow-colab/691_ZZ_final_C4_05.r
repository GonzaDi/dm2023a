...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910C405"
PARAM$exp_input  <- "HT6510C405"
...
PARAM$semillas  <- c( 307873, 929209, 191953, 727843, 811127, 100069, 157537, 319977, 973157, 137219 ) #reemplazar por las propias semillas
